...
_BusReservation _$BusReservationFromJson(Map<String, dynamic> json) =>
    _BusReservation(
      reservationId: (json['reservationId'] as num?)?.toInt(),
      customer: Customer.fromJson(json['customer'] as Map<String, dynamic>),
      busSchedule: BusSchedule.fromJson(
        json['busSchedule'] as Map<String, dynamic>,
      ),
...
Map<String, dynamic> _$BusReservationToJson(_BusReservation instance) =>
    <String, dynamic>{
