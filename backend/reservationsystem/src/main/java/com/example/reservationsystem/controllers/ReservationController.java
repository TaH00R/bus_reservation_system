...
public class ReservationController {
    ...
    public ResponseModel<Reservation> addReservation(@RequestBody Reservation reservation) {
        ...
        return new ResponseModel<>(HttpStatus.OK.value(),  "Reservation successfully added", res);
    }
    ...
    @GetMapping("/query")
    public ResponseEntity<List<Reservation>> getReservationsByScheduleAndDepartureTime(
