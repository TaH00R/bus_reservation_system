...
import com.example.reservationsystem.repos.BusRouteRepository;
...
public class BusScheduleServiceImpl implements BusScheduleService {
    ...
    public BusSchedule addSchedule(BusSchedule busSchedule) {
        final Boolean exists = busScheduleRepository.
        ...
        if(exists){
            throw new ReservationApiException(HttpStatus.CONFLICT,"BusSchedule already exists");
        }
