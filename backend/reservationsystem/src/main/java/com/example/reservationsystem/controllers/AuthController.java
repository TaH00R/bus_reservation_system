...
import com.example.reservationsystem.models.AuthResponseModel;
import com.example.reservationsystem.security.JwtTokenProvider;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<AuthResponseModel> login(@RequestBody AppUsers appUser) {
